...
# sempre que for pra filtar uma coluna: tabela_venda [['...', '...']] ou tabela_vendas.groupby('...').sum() \
...
# SEMPRE QUE FAÇO UMA OPERAÇAO ENTRE COLUNAS (vou ter como resultado uma série de dados, ao invés de uma ''tabela'') Dessa forma, para TRANSFORMAR esse resultado EM TABELA, e que fique bonitinha, EU COLOCO um .to_frame NO FINAL.
...
# mail.HTMLBody: é opcional. O copro do nosso e-mail é um html, dessa forma, ele  pode ser todo personalizado. Com isso, temos q trnsformar essa tabela (tabelinha bonitinha), numa tabela html, e para isso utilizo o to_html()
...
# # formatters={'Valor Final': 'R${:,.2f}'.format  o formatters vai formatar nosso número={quem queremos modificar: o que quero modificar}
# toda formatação começa com 2 pontos; virgula separador de milhar; ponto, separador de decimal; e 2f quantas casas decimais (2 float), ou seja, duas casas decimais.
mail.HTMLBody = f''' 
<p>Prezados,</p>
